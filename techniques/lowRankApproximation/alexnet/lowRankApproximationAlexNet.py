...
# Applica l'approssimazione a basso rango al primo layer convoluzionale di AlexNet
alexnet.features[0] = low_rank_approximation(alexnet.features[0], rank=10)

# Salva il modello ottimizzato
os.makedirs("minimizedModels/lowRankApproximation", exist_ok=True)
torch.save(alexnet.state_dict(), 'minimizedModels/lowRankApproximation/alexnet_low_rank.pth')
