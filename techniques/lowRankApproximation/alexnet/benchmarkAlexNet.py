...
# Classe per AlexNet con approssimazione a basso rango
...
model.load_state_dict(torch.load('minimizedModels/lowRankApproximation/alexnet_low_rank.pth'), strict=False)
...
model_size = os.path.getsize("minimizedModels/lowRankApproximation/alexnet_low_rank.pth") / (1024 ** 2)

# Salva i risultati in un file di testo
save_results("benchmark/lowRankApproximation/alexnet", "alexnet", accuracy, precision, recall, auc_roc, inference_time, throughput, model_size)
