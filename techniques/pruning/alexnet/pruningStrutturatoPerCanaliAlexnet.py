...
# Applica pruning strutturato su tutti gli strati Conv2d
...
# Salva il modello pruned e ridotto
os.makedirs("minimizedModels/pruning", exist_ok=True)
torch.save(model.state_dict(), os.path.join("minimizedModels/pruning", 'alexnet_pruned_strutturato_per_canali.pth'))